...
function amain () {
    ...
    tbgeometry="$path/tmp/geometry_$wtitle.txt";HEIGHT=500;WIDTH=600
    [ -f "$tbgeometry" ] && source "$tbgeometry" 
...
function tb_meta_info () {
	...
	if [ "$PRIMKEY" = "" ];then PRIMKEY="rowid";ID=0;TNAME="rowid$del$TNAME";TLINE="rowid$del2$TLINE"  ;fi
